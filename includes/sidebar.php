...
<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
        <div class="profile-sidebar">
            <div class="profile-userpic">
                <img src="Female.png" class="img-responsive" alt="">
            </div>
...
?>
        ...
        <ul class="nav menu">
            ...
            <li class="parent "><a data-toggle="collapse" href="#sub-item-1">
                ...
                <ul class="children collapse" id="sub-item-1">
                    <li><a class="" href="add-brkdwn-details.php">
                        <span class="fa fa-arrow-right">&nbsp;</span><font size='2px'> Add Breakdown Details</font>
                    </a></li>
                    <li><a class="" href="manage-brkdwn-details.php">
                        <span class="fa fa-arrow-right">&nbsp;</span> View Details
                    </a></li>
  ...
  <li class="parent "><a data-toggle="collapse" href="#sub-item-2">
                ...
                <ul class="children collapse" id="sub-item-2">
                    ...
                    <li><a class="" href="view_invoice_issued.php">
                        <span class="fa fa-arrow-right">&nbsp;</span> Recieved Invoices
                    </a></li>
            ...
            <li><a href="send_notification.php"><em class="fa fa-envelope">&nbsp;</em> Contact Admin</a></li>
