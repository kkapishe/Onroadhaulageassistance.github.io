...
if(isset($_POST['submit']))
  {
    ...
    $ret=mysqli_query($con, "select Email from admin where Email='$email' ");
    $result=mysqli_fetch_array($ret);
    if($result>0){
$msg="This email  associated with another account";
    }
    else{
    $query=mysqli_query($con, "insert into admin(FullName, MobileNumber, Email,  Password) value('$fname', '$mobno', '$email', '$password' )");
    if ($query) {
...
<body>
	<div class="row">
			<h2 align="center">Haulage Trucks Assistance</h2>
	<hr />
